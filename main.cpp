...
int main() {
    ...
    std::filesystem::create_directories("results/" + run_id);

    std::string train_log = "results/" + run_id + "/train_stats.csv";
    std::string eval_log = "results/" + run_id + "/eval_stats.csv";
    std::string model_path = "results/" + run_id + "/vit_trained.pt";
